...
**Prerequisites**: This guide assumes familiarity with Effect-TS fundamentals:
- `core-concepts.md` - Effect.gen, Effect.Service, pipe, Context
- `error-management.md` - Tagged errors, catchTag, retry patterns
- `building-apis.md` - HTTP server patterns
...
**Effect Fundamentals**: See `core-concepts.md` for Effect.gen pattern basics.
...
**Effect Fundamentals**: See `core-concepts.md` for Effect.Service basics.
...
**Effect Fundamentals**: See `core-concepts.md` for Effect Config module.
...
**Effect Fundamentals**: See `error-management.md` for Data.TaggedError basics.
